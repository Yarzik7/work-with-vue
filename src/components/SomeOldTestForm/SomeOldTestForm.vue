<template>
  <div class="some-item-form-wrapper">
    <v-form id="home-view-form" class="v-form-wrap" @submit.prevent="onSubmit">
      <v-checkbox v-model="dataFromFields.someCheckbox" label="Checkbox 1" class="v-some-checkbox"></v-checkbox>
      <some-input
        ref="btns"
        :value="someMap"
        type="checkBtns"
...
const INIT_FORM_ALL_VALUES = { template: '', text: '', someType: '', someOps1: [], someOps2: [], someCheckbox: false };
